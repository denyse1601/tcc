...
export function Referencias() {
  return (
    <main className="flex flex-col min-h-screen p-4 md:p-6 pt-24 md:pt-32 text-[#451A5D] dark:text-white bg-[#B3A4D8] dark:bg-[#451A5D] transition-colors duration-500">
      <h1 className="text-3xl sm:text-4xl md:text-5xl font-semibold mb-6 text-center text-[#B2009A] dark:text-[#FF73EC] mt-20">
        REFERÊNCIAS
      </h1>
